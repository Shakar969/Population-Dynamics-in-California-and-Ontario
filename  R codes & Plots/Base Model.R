...
plot(t_vals, p1[1 ,], type = "o", col = "blue",
     xlab = "Year", ylab = "Population", ylim = range(p1),
     main = "Population Prediction from 1955 to 2100 model 1",xaxt = "n")
lines(t_vals, p1[2 ,], type = "o", col = "red")
...
#In 2020
(2020-1955)/5=13  Since 1955 is at t=1 in this code, 1+13=14.
p1[,14]
#Model 2
...
plot(t_vals, p2[1 ,], type = "o", col = "blue",
     ...
     main = "Population Prediction from 1955 to 2100 for model 2",xaxt = "n")
...
plot(t_vals, p3[1 ,], type = "o", col = "blue",
     ...
     main = "Population Prediction from 1955 to 2100 for combine model",xaxt = "n")
